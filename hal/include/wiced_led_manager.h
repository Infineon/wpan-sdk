 ...
 *
 */
typedef wiced_bt_gpio_numbers_t wiced_led_t;
...
typedef struct
{
    ...
    /* LED manager internal use fields */
    platform_led_config_t platform_config;
 ...
 *
 * @param  config      : Configurations for the LED.
 ...
 * @return             : result.
 */
wiced_result_t wiced_led_manager_deinit(void);
 ...
 *
 * @param  led         : LED to be reconfigured.
 * @return             : result.
 */
