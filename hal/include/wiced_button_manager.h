...
typedef struct
{
    wiced_bt_gpio_numbers_t gpio; /**< GPIO pin number for the physical button on the board */
...
typedef struct
{
    ...
    const wiced_platform_button_config_t * platform;    /**< Button platform configuration      */
