...
static void __assert_func_in_thread(const char *file, int line, const char *func, const char *failedexpr);
...
void __assert_func(const char *file, int line, const char *func, const char *failedexpr)
{
    ...
    if (ipsr.isr == 0) {
        __assert_func_in_thread(file, line, func, failedexpr);
    }
...
__attribute__((section(".text_in_ram")))
void __assert_func_in_thread(const char *file, int line, const char *func, const char *failedexpr)
{
